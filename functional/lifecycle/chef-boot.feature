...
Feature: Check chef attributes set
    ...
    @ec2 @vmware @gce @cloudstack @openstack @rackspaceng @systemd
    ...
    @ec2 @vmware @gce @cloudstack @openstack @rackspaceng @openstack
    ...
    @ec2 @vmware @gce @cloudstack @rackspaceng @openstack @restartfarm
    Scenario: Cleanup farm
        When I stop farm
        And wait all servers are terminated

    @ec2 @vmware @gce @cloudstack @openstack @rackspaceng
