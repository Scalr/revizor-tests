...
from api.utils.helpers import unique_uuid, remove_empty_values
    ...
    def test_deploy_complex_farm(self):
        ...
        for farm_role in farm_roles:
            ...
            if farm_role.cloudPlatform == Platform.VMWARE:
                assert any(
                    self.ext_vmware_network_id == network.id for network in farm_role_details.networking.networks)
