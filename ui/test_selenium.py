...
class TestSelenium():
    ...
    def test_create_new_acl(self):
        ...
        message_popup = elements.Label(acl_page.driver, text="ACL successfully saved")
    ...
    def test_create_new_user(self):
        ...
        message_popup = elements.Label(users_page.driver, text="User successfully added and invite sent")
    ...
    def test_create_new_team(self):
        ...
        message_popup = elements.Label(teams_page.driver, text="Team successfully saved")
        assert message_popup.displayed(timeout=15), "No message present about successfull saving of the new Team"
        table_entry = elements.Label(teams_page.driver, text="Selenium Team")
    ...
    def test_new_environment(self):
        ...
        message_popup = elements.Label(env_page.driver, text="Environment successfully created")
